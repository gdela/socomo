 ...
 * won't compile fixture classes to the {@code target/classes_java7} folder by itself,
 * you need to run {@code mvn compile} to have them compiled by maven as defined in the
 * {@code pom.xml} file of this module.
 */
@RunWith(Enclosed.class)
public final class Java7TestSuite {

	private static final File FIXTURE_ROOT = new File("target/classes_java7/fixture/");

	private Java7TestSuite() {}
