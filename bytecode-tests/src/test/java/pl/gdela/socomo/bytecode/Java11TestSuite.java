...
/**
 * The tests for analyzing bytecode produced for Java 11 runtime. Mind that probably your IDE
 * won't compile fixture classes to the {@code target/classes_java11} folder by itself,
 * you need to run {@code mvn compile} to have them compiled by maven as defined in the
 * {@code pom.xml} file of this module.
 */
@RunWith(Enclosed.class)
public final class Java11TestSuite {

	private static final File FIXTURE_ROOT = new File("target/classes_java11/fixture/");

	private Java11TestSuite() {}
